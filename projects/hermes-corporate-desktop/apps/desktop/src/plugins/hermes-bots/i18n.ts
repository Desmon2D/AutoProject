...
const en: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update DIT Agent to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update DIT Agent to chat with bots on other connections.',
...
const ja: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには DIT Agent を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには DIT Agent を更新してください。',
...
const zh: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 DIT Agent 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 DIT Agent 以与其他连接上的机器人聊天。',
    chatEmpty: '说点什么开始吧。',
    kickoff: '你好，介绍一下你自己吧！'
  },
  avatar: {
...
const zhHant: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '請更新 DIT Agent 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 DIT Agent 以與其他連線上的機器人聊天。',
    chatEmpty: '說點什麼開始吧。',
    kickoff: '你好，介紹一下你自己吧！'
  },
  avatar: {
