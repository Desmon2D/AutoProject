...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting DIT Agent…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting DIT Agent.',
  ...
  settings: {
    ...
    gateway: {
      ...
      restartingMessage: 'DIT Agent will reconnect using the saved settings — the shell stays open.',
      ...
      sshErrPlatform:
        'Unsupported remote platform. DIT Agent SSH mode supports Linux, macOS, and Windows remote hosts.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up DIT Agent',
    setupChoiceDesc:
    ...
    localStartUnavailable: 'Local installation could not start. Restart DIT Agent and try again.',
    remoteSetupTitle: 'Connect to existing Hermes',
    remoteSetupDesc: 'Enter your gateway URL. DIT Agent will detect whether it needs a token or browser sign-in.',
    ...
    settingUpTitle: 'Setting up DIT Agent',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with DIT Agent",
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart DIT Agent to use Save Image.',
    restartToSaveImages: 'Restart DIT Agent to save images',
