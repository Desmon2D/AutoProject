...
export const ar = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'جار تشغيل DIT Agent...'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل DIT Agent.',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'يشغّل DIT Agent بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Hermes تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      ...
      restartingMessage: 'سيعيد DIT Agent الاتصال باستخدام الإعدادات المحفوظة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك DIT Agent',
