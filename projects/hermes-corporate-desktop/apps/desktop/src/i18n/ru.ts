...
export const ru = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Запуск DIT Agent…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'Бэкенд приложения отклонил запрос (405 Method Not Allowed). Попробуйте перезапустить DIT Agent.',
  ...
  settings: {
    ...
    gateway: {
      ...
      restartingMessage: 'DIT Agent переподключится с сохранёнными настройками — оболочка останется открытой.',
      ...
      sshErrPlatform:
        'Неподдерживаемая удалённая платформа. SSH-режим DIT Agent поддерживает удалённые хосты Linux, macOS и Windows.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Настройка DIT Agent',
    setupChoiceDesc:
    ...
    localStartUnavailable: 'Не удалось начать локальную установку. Перезапустите DIT Agent и попробуйте снова.',
    remoteSetupTitle: 'Подключиться к существующему Hermes',
    remoteSetupDesc: 'Введите URL вашего шлюза. DIT Agent определит, нужен токен или вход через браузер.',
    ...
    settingUpTitle: 'Настройка DIT Agent',
  ...
  onboarding: {
    headerTitle: 'Настроим для вас DIT Agent',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `DIT Agent v${version}`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Перезапустите DIT Agent, чтобы использовать «Сохранить изображение».',
    restartToSaveImages: 'Перезапустите DIT Agent, чтобы сохранять изображения',
